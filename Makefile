...
DEFINES := -DAURIXOS_VERSION=$(AURIXOS_VERSION) -DAURIXOS_ARCH=$(AURIXOS_ARCH) -DAURIXOS_ARCH_COMMON=$(AURIXOS_ARCH_COMMON) -DAURIXOS_CONFIGURATION=L\"$(AURIXOS_CONFIGURATION)\" -DAURIXOS_$(ARCH)
