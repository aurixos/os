override BOOT_FILE_STAGE1_HDD := $(BUILD_DIR)/boot/stage1-hdd.bin
override BOOT_FILE_STAGE1_CD := $(BUILD_DIR)/boot/stage1-cd.bin
override BOOT_FILE_STAGE1_PXE := $(BUILD_DIR)/boot/stage1-pxe.bin
